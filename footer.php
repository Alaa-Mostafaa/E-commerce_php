<footer class="section-p1">
        <div class="col">
            ...
            <p><strong><?php echo $msg['Address: 526 manchster Road, street 32, manchster'] ?></p>
            <p><strong><?php echo $msg['Phone: 0106244875'] ?></p>
            <p><strong><?php echo $msg['Hours: 10AM - 10Pm, Sat- thus'] ?></p>
            <div class="follow">
        ...
        <div class="col">
            ...
            <a href="#"><?php echo $msg['Sign in'] ?></a>
            <a href="#"><?php echo $msg['View Cart'] ?></a>
